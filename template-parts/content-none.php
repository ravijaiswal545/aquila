...
<section class="no-result not-found">
    <header class="page-header">
        <h1 class="page-title">
            <?php esc_html_e('Nothing Found', 'aquila'); ?></h1>
    </header>
    <div class="page-content">
        ...
        <?php
            ...
            <p><?php esc_html_e('Sorry but nothing matches your searched item. Please try again with some different keywords.', 'aquila'); ?></p>
